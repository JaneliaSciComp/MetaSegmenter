...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        sys.exit("usage: MS_UT_Labels2RGB.py  <dir_segmentation_labels> <dir_RGB>  \n")
    ...
    for file in os.listdir(indir):
        ...
        outdata = label2rgb(label_image, image=bwdata)

        img = Image.fromarray(numpy.uint8(outdata/numpy.max(outdata)*255.))
        img.save(outpath)
